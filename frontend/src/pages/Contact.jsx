...
const InstagramIcon = () => (
  <svg xmlns="https://www.instagram.com/stat___.___/?__pwa=1" className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
const YouTubeIcon = () => (
  <svg xmlns="https://youtu.be/DLMkUr_GIIc?si=Tua6bd-8Wllts7Qc" className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
